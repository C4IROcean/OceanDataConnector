...
mapbox_style_url_ipyleaflet = f'https://api.mapbox.com/styles/v1/oceandatafoundation/clwg6xklg00an01pcgmeufjxq/tiles/256/{{z}}/{{x}}/{{y}}@2x?access_token={mapbox_token}'
